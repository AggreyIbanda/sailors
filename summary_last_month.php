...
<table>
    <!--   bar -->
    <tr><th colspan="4">Bar Sales This Month (From <?php echo $date_start; ?> to <?php echo $date_end; ?>)</th></tr>
    ...
    <table>
        <!-- butchery       -->
        <tr><th colspan="5">Butchery  Sales This Month (<?php echo $date_start; ?> to <?php echo $date_end; ?>)</th></tr>
    ...
    <table>
        <!--    rooms    -->
        <tr><th colspan="4">Occupied Rooms  This Month (<?php echo $date_start; ?> to <?php echo $date_end; ?>)</th></tr>
